...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "otherProjects.running": "其他项目正在运行",
    "otherProjects.switch": "切换到该对话",
    "otherProjects.dismiss": "忽略",
    ...
    "sidebar.awaitingReply": "待你处理",
    "sidebar.awaitingReplyTitle": "已完成，等待你的回复",
    "sidebar.awaitingReplyCount": "待处理（{count}）",
