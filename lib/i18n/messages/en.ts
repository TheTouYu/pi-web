...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "otherProjects.running": "Running in other projects",
    "otherProjects.switch": "Switch to this conversation",
    "otherProjects.dismiss": "Dismiss",
    ...
    "sidebar.awaitingReply": "Needs your attention",
    "sidebar.awaitingReplyTitle": "Completed and waiting for your reply",
    "sidebar.awaitingReplyCount": "Needs attention ({count})",
